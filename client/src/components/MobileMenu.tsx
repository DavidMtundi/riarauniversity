      ...
      <div className="bg-[var(--color-bg-secondary)] p-4">
        <div className="text-center">
          <div className="flex flex-wrap justify-center gap-4 text-sm text-[var(--color-text-tertiary)]">
            ...
            <a href="https://library.riarauniversity.ac.ke/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-text-primary)] transition-colors font-semibold text-[var(--color-riara-red)] touch-manipulation" style={{ touchAction: 'manipulation' }}>Library</a>
