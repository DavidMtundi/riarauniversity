          ...
          <Container>
            <div className="max-w-4xl mx-auto">
              <div className="mb-6">
                ...
                {career.time && (
                  <Badge variant="outline" className="text-base px-4 py-2 border-[var(--color-stanford-red)] text-[var(--color-stanford-red)]">
                    {career.time}
                  </Badge>
                )}
              </div>
              ...
              <div className="flex flex-wrap gap-6 text-[var(--color-text-secondary)]">
                ...
                {career.time && (
                  <div className="flex items-center gap-2">
                    <Clock className="h-5 w-5 text-[var(--color-stanford-red)]" />
                      ...
                      <div className="space-y-4">
                        ...
                        {career.link && career.link !== "#" && (
                          <div className="pt-4 border-t space-y-2">
                            <Button
                              asChild
                              className="w-full bg-[var(--color-stanford-red)] text-white hover:bg-[var(--color-stanford-red-dark)]"
                            >
