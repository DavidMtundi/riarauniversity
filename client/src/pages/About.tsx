...
export default function About() {
  const { data: leadership = [], isLoading: leadershipLoading, error: leadershipError } = useQuery<LeadershipMember[]>({
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pt-24">
        ...
        <section className="bg-[var(--color-bg-secondary)] py-16 md:py-20">
          <Container className="px-0 sm:px-1 md:px-2 lg:px-3">
          ...
          <Container className="px-0 sm:px-1 md:px-2 lg:px-3">
            <div className="max-w-5xl mx-auto">
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-6 h-auto p-1 bg-[var(--color-bg-secondary)] rounded-lg mb-8">
                  <TabsTrigger 
                    value="story" 
                    className="data-[state=active]:bg-[var(--color-stanford-red)] data-[state=active]:text-white text-sm md:text-base py-3"
                  >
                    Our Story
                  </TabsTrigger>
                  <TabsTrigger 
                ...
                <TabsContent value="milestones" className="mt-0">
                  <div className="prose prose-lg max-w-none">
                    ...
                    {/* Partnerships Section (included in Milestones tab) */}
                    <div className="mt-12 pt-8 border-t border-[var(--color-border-secondary)]">
