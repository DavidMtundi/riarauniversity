        ...
        <section className="bg-muted/30 py-16">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">About Riara University</h1>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="max-w-4xl mx-auto space-y-12">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-serif font-semibold mb-6">The Riara Story</h2>
              ...
              {/* Key Milestones */}
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-serif font-semibold mb-6">Some Key Milestones</h2>
                <p className="text-base text-muted-foreground leading-relaxed mb-6">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-serif font-semibold mb-6">Partnerships and Collaborations</h2>
                <p className="text-base text-muted-foreground leading-relaxed mb-6">
              ...
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-serif font-semibold mb-6">Our Vision, Mission, and Values</h2>
                ...
                <div className="mb-8">
                  <h3 className="text-2xl font-serif font-semibold mb-4">Our Core Purpose</h3>
                  <p className="text-base text-muted-foreground leading-relaxed">
                ...
                <div className="mb-8">
                  <h3 className="text-2xl font-serif font-semibold mb-4">Guiding Mantra</h3>
                  <p className="text-base text-muted-foreground leading-relaxed">
              ...
              {/* Our Schools */}
              <div className="prose prose-lg max-w-none">
                <h2 className="text-3xl font-serif font-semibold mb-6">Our Schools</h2>
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <a href={SCHOOL_LINKS.law} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    Riara Law School
                  </a>
                  <a href={SCHOOL_LINKS.business} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    School of Business
                  </a>
                  <a href={SCHOOL_LINKS.computingScience} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    School of Computing Sciences
                  </a>
                  <a href={SCHOOL_LINKS.internationalRelations} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    School of International Relations & Diplomacy
                  </a>
                  <a href={SCHOOL_LINKS.communicationJournalism} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    School of Communication and Multimedia Journalism
                  </a>
                  <a href={SCHOOL_LINKS.education} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline font-medium">
                    School of Education
                  </a>
                </div>
              </div>
              ...
              <div className="prose prose-lg max-w-none border-t pt-8">
                <h2 className="text-3xl font-serif font-semibold mb-6">Contact Information</h2>
                <div className="space-y-4">
                  <p className="text-base text-muted-foreground">
                    <strong>Email:</strong> <a href="mailto:info@riarauniversity.ac.ke" className="text-primary hover:underline">info@riarauniversity.ac.ke</a>
                  </p>
                  <p className="text-base text-muted-foreground">
                    <strong>Telephone:</strong> <a href="tel:+254703038000" className="text-primary hover:underline">+254 703 038 000</a>
                  </p>
                  <p className="text-base text-muted-foreground">
                    <strong>Address:</strong> 49940 – 00100, Nairobi
                  </p>
                  <p className="text-base text-muted-foreground">
                    <strong>Location:</strong> Raila Odinga Road, formerly Mbagathi Way
                  </p>
                  <p className="text-base text-muted-foreground">
                    <strong>Opening Hours (Mon - Fri):</strong> 8:00am - 5:00pm
                  </p>
                </div>
              </div>
