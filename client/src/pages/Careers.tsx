      ...
      <main className="flex-1 pt-12 sm:pt-14 md:pt-24">
        ...
        <section className="bg-gradient-to-b from-white to-[var(--color-bg-secondary)]/30 py-10 md:py-12">
          <Container>
            ...
            <div className="bg-white rounded-xl border-l-4 border-[var(--color-riara-red)] p-6 md:p-8 shadow-sm">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <p className="text-base text-[var(--color-text-secondary)]">
                      <span className="font-semibold text-[var(--color-riara-red)]">{filteredCareers.length}</span> {filteredCareers.length === 1 ? 'open position' : 'open positions'}
                      {hasActiveFilters && (
                  ...
                  <div className="sticky top-24">
                    ...
                    <div className="mb-8 bg-white rounded-xl border border-gray-200 p-4 shadow-sm">
                      <button
                        ...
                        className="w-full flex items-center justify-between text-left mb-4 text-base font-semibold text-[var(--color-text-primary)] hover:text-[var(--color-riara-red)] transition-colors"
                      >
                  ...
                  {filteredCareers.length === 0 ? (
                    ...
                    <div className="space-y-4">
                      {filteredCareers.map((career, index) => (
                        <div
                          key={career.id}
                          className="group bg-white rounded-xl border-2 border-gray-200 hover:border-[var(--color-riara-red)]/50 shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1"
                            ...
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-3">
                                  <span className="px-3 py-1 text-xs font-semibold uppercase tracking-wide bg-[var(--color-riara-red)]/10 text-[var(--color-riara-red)] rounded-full">
                                    {career.type}
                                  </span>
                                  {career.time && (
                                ...
                                <h3 className="text-xl md:text-2xl font-serif font-bold text-[var(--color-text-primary)] mb-3 group-hover:text-[var(--color-riara-red)] transition-colors duration-300">
                                  {career.title}
                                </h3>
                                ...
                                <div className="flex items-center gap-2 text-[var(--color-riara-red)] font-semibold group-hover:gap-3 transition-all duration-300">
